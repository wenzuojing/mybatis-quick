...
public class AutoGenerator {
    ...
    public static void run(ConfigGenerator config) {
        if (config == null) {
            throw new MybatisQuickException(" ConfigGenerator is null. ");
        } else if (config.getIdType() == null) {
            throw new MybatisQuickException("ConfigGenerator IdType is null");
        }
    ...
    private void buildEntityBean(List<FieldInfo> fieldInfos, String tableComment,
        ...
        if (config.getIdType() != IdType.ID_WORKER) {
            bw.write("import com.github.wens.mybatis.annotations.IdType;");
            bw.newLine();
        }
        bw.write("import com.github.wens.mybatis.annotations.TableField;");
        bw.newLine();
        bw.write("import com.github.wens.mybatis.annotations.TableId;");
        bw.newLine();
        bw.write("import com.github.wens.mybatis.annotations.TableName;");
        bw.newLine();
        bw.write("import com.github.wens.mybatis.examples.Example;");
        bw.newLine();
