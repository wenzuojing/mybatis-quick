...
import com.github.wens.mybatis.plugins.pagination.DialectFactory;
import com.github.wens.mybatis.plugins.pagination.IDialect;
            ...
            if (dialectType != null && !"".equals(dialectType)) {
                ...
                if (dialectClazz != null && !"".equals(dialectClazz)) {
                    try {
                        ...
                        throw new MybatisQuickException("Class :" + dialectClazz + " is not found");
                    }
                }
            }
